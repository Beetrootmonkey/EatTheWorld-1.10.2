...
//			addDrop(new ItemStack(event.getEntity().isBurning() ? ModItems.cooked_horse : ModItems.raw_horse, amount),
//					event);
//
//		} else if (event.getEntityLiving() instanceof EntitySpider &&
//				event.getEntity().isBurning()) {
//			replaceDrop(Items.SPIDER_EYE, new ItemStack(ModItems.cooked_spider_eye), event);
//
//		}
//	}
