...
public class ModItems {
	...
	public static void init() {
		...
		cooked_bat = register(new ItemModFood("cooked_bat", 4, 5f));
		cooked_cat = register(new ItemModFood("cooked_cat", 5, 6f));
		cooked_dragon = register(new ItemModFood("cooked_dragon", 1, 1f));
//		cooked_endermite = register(new ItemModFood("cooked_endermite", 1, 1f));
		cooked_guardian = register(new ItemModFood("cooked_guardian", 5, 6f));
		cooked_horse = register(new ItemModFood("cooked_horse", 8, 12.8f));
		cooked_shulker = register(new ItemModFood("cooked_shulker", 4, 8f));
		cooked_silverfish = register(new ItemModFood("cooked_silverfish", 4, 5f));
		...
		cooked_squid = register(new ItemModFood("cooked_squid", 5, 8f));
		cooked_villager = register(new ItemModFood("cooked_villager", 6, 9.6f));
		cooked_wolf = register(new ItemModFood("cooked_wolf", 5, 6f));
		...
		raw_bat = register(new ItemModFood("raw_bat", 1, 0.3f));
		raw_bread = register(new ItemBase("raw_bread"));
		raw_cat = register(new ItemModFood("raw_cat", 2, 0.3f));
...
//		raw_endermite = register(new ItemModFood("raw_endermite", 1, 1f));
		raw_ghast = register(new ItemModFood("raw_ghast", 4, 6f));
		raw_guardian = register(new ItemModFood("raw_guardian", 2, 0.4f));
		raw_horse = register(new ItemModFood("raw_horse", 3, 1.8f));
		raw_shulker = register(new ItemModFood("raw_shulker", 1, 0.1f));
		raw_silverfish = register(new ItemModFood("raw_silverfish", 1, 0.1f));
		raw_spider_leg = register(new ItemModFood("raw_spider_leg", 1, 0.2f));
		raw_squid = register(new ItemModFood("raw_squid", 2, 0.4f));
		raw_villager = register(new ItemModFood("raw_villager", 2, 0.4f));
		raw_wolf = register(new ItemModFood("raw_wolf", 2, 0.4f));
